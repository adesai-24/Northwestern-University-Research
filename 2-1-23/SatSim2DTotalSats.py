# 2/8/23 2D Mega Constellation Simulation by Shaan Doshi and Aadi Desai with guidance from Prof Randall Berry
...
axs.set_ylabel("Probability of Interferences")
axs.set_title("Number of Satellites vs Interferences")
plt.plot(numSatsArr, data[0][2], label="A success")
plt.plot(numSatsArr, data[0][0], label="A interference")
plt.plot(numSatsArr, data[0][1], label="A no coverage")
plt.plot(numSatsArr, data[1][2], label="B success")
plt.plot(numSatsArr, data[1][0], label="B interference")
plt.plot(numSatsArr, data[1][1], label="B no coverage")
plt.legend()
plt.show()
