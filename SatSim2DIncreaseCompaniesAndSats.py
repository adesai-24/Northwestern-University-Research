...
for a in range(49):
    ...
    companyI2.append(results[0]["interference"]) 
    companyN2.append(results[0]["noCoverage"])
    companyS2.append(results[0]["success"])
...
for a in range(49):
    ...
    companyI3.append(results[0]["interference"]) 
    companyN3.append(results[0]["noCoverage"])
    companyS3.append(results[0]["success"])
...
plt.plot(numSatsArr, companyI2, label="Interference 2")
plt.plot(numSatsArr, companyN2, label="No Coverage 2")
plt.plot(numSatsArr, companyS2, label="Success 2")
plt.plot(numSatsArr, companyI3, label="Interference 3")
plt.plot(numSatsArr, companyN3, label="No Coverage 3")
plt.plot(numSatsArr, companyS3, label="Success 3")
