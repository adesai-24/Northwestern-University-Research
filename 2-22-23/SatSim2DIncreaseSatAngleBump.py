...
for p in range(49):
    ...
    for t in range(1, time+1):
        ...
        successVal += resultsTemp[0]["success"]

    successVal /= companyClientSizes[0]
    print(successVal)
    successArr.append(successVal)
...
axs.set_title("Angle Effect on Satellite Bump")

plt.plot(numSatsArr, successArr, label="SA=10")
