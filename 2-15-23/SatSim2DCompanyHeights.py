...
time = 600 # the time the simulation repeats in order to gain accuracy
...
axs.set_xlabel("Height of Company A")
axs.set_ylabel("Probabilities")
axs.set_title("Height of Company A vs Probabilities")
plt.plot(heightA, data[0][2], label="A success")
plt.plot(heightA, data[0][0], label="A interference")
plt.plot(heightA, data[0][1], label="A no coverage")
plt.plot(heightA, data[1][2], label="B success")
plt.plot(heightA, data[1][0], label="B interference")
plt.plot(heightA, data[1][1], label="B no coverage")
plt.legend() 
plt.show()
